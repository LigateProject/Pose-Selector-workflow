...
bash HyperQueueScripts/analyseCompletionAndCleanUp.sh >> round${X}.txt
bash HyperQueueScripts/analyseCompletionAndCleanUp.sh >> round${X}.txt

## clean up round${X}.txt and then start second part
#bash HyperQueueScripts/countPoses.sh >> round${X}.txt
#bash HyperQueueScripts/identifyRemainingPoses.sh >> round${X}.txt
#file=round${X}.txt
